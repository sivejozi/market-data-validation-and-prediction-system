  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ color:C.text, fontWeight:700, fontSize:15, letterSpacing:"0.02em" }}>
          MarketGuard
        </span>
        <span style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ marginBottom:32, textAlign:"center" }}>
            ...
            <h1 style={{ color:C.text, fontSize:22, fontWeight:700, margin:0, marginBottom:6 }}>
              Welcome back
            </h1>
          ...
          {[
            { label:"Email",    value:email,    setter:setEmail,    type:"email",    placeholder:"you@institution.com", id:"email"    },
            ...
            <div key={id} style={{ marginBottom:16 }}>
              <label style={{ color:C.muted, fontSize:12, fontWeight:600, letterSpacing:"0.06em", display:"block", marginBottom:6 }}>
                {label.toUpperCase()}
              </label>
              <input
                type={type}
          ...
          <div style={{ display:"flex", justifyContent:"flex-end", marginBottom:24 }}>
            <span style={{ color:C.accent, fontSize:12, cursor:"pointer" }}>Forgot password?</span>
          </div>
